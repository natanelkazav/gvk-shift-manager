...
-- Phase 10.5.11 · Logical slot de-duplication for the management calendar.
-- Frozen Job Types are already excluded through jt.is_active = true.
-- The remaining duplicates came from equivalent slots carrying different technical shift_code values.
