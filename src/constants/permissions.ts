    ...
    },
    {
      ...
      permissions: [
        ...
        },
        {
          ...
          label: 'עריכת כל כוננות בחודש הנוכחי והבא',
          description:
            'מאפשרת לשנות כל כונן משובץ בלוח שפורסם של החודש הנוכחי או החודש הבא, גם בכוננות של משתמש אחר וגם בתאריך שכבר עבר בחודש הנוכחי.',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      permissions: [
        ...
        },
        {
          ...
          label: 'עריכת כל משמרת כונן בוקר בחודש הנוכחי והבא',
          description:
            'מאפשרת לשנות כל שיבוץ בלוח כונני בוקר שפורסם של החודש הנוכחי או החודש הבא, גם משמרת של משתמש אחר וגם משמרת מתאריך שכבר עבר בחודש הנוכחי.',
        },
      ],
    },
    {
